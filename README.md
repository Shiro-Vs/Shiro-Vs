...
<img src="./assets/banner.svg" width="100%" alt="ShiroVS terminal banner" />
...
**🏪 Fivuza** — ERP SaaS multi-tenant
ERP para pequeños y medianos negocios (bodegas, gimnasios, retail): inventario, ventas y usuarios por tenant.
`Django REST` `React` `TypeScript` `Docker`
...
**📈 Vantage**
Aplicación web con API REST en Spring Boot y frontend en React + TypeScript.
...
`Spring Boot` `Java` `Angular` `MySQL`
...
![Stats](https://github-readme-stats.vercel.app/api?username=Shiro-Vs&show_icons=true&theme=default&hide_border=true&count_private=true)
![Top Languages](https://github-readme-stats.vercel.app/api/top-langs/?username=Shiro-Vs&layout=compact&hide_border=true)
